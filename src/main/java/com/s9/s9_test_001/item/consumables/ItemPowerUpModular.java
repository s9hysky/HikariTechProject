package com.s9.s9_test_001.item.consumables;

import com.s9.s9_test_001.entity.creatures.EntityModUnit;
import com.s9.s9_test_001.item.ItemBase;
import com.s9.s9_test_001.util.CommonFunctions;
import com.s9.s9_test_001.util.EntityUtil;
...
import static com.s9.s9_test_001.util.NBTStrDef.IDLNBTDef.MARK_TOTAL_COUNT;
    ...
    public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer playerIn, EntityLivingBase target, EnumHand handIn) {
        if (target instanceof EntityModUnit)
        {
            ...
            if (legalTarget.is_mechanic)
            {
                ...
                {
                    CommonFunctions.SafeSendMsgToPlayer(playerIn, "s9_test_001.msg.upgrade_module.req_lv", String.valueOf(requireLv));
                    return false;
                }
                ...
                if (!playerIn.world.isRemote)
                {
                    ...
                    if (success)
                    {
                        ...
                        CommonFunctions.SafeSendMsgToPlayer(playerIn, "s9_test_001.msg.upgrade_module.ok", valueBefore, valueAfter);
