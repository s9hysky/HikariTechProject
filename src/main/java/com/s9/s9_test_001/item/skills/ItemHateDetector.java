...
import static com.s9.s9_test_001.util.NBTStrDef.IDLNBTDef.STATE;
import static com.s9.s9_test_001.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.s9.s9_test_001.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "s9_test_001.msg.being_targeted";
