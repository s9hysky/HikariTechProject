...
import com.s9.s9_test_001.util.Teleport;
...
public class CommandDimTeleport extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        }catch (NumberFormatException e)
        {
            ...
            {
                CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP) sender, "s9_test_001.msg.dim_id_invalid", TextFormatting.RED, s);
            }
            return;
        }
