...
public class ModConfig {
    ...
    @Config.LangKey("configgui.s9_test_001.category.Menu0.GeneralConf")
...
//        @Config.LangKey("s9_test_001.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "s9_test_001.msg.welcome";
    }

    @Config.LangKey("configgui.s9_test_001.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.s9_test_001.category.Menu0.SpawnConf")
