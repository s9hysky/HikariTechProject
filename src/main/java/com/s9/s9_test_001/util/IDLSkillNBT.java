...
import com.s9.s9_test_001.item.skills.ItemSkillBase;
...
import static com.s9.s9_test_001.util.CommonDef.INT_AS_FLOAT;
import static com.s9.s9_test_001.util.NBTStrDef.IDLNBTDef.*;
import static com.s9.s9_test_001.util.NBTStrDef.IDLNBTUtil.*;
    ...
    public static void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag,
        ...
        if (shiftPressed)
        {
            ...
            if (showGuaSocketDesc)
            {
                ...
                if (guaTotal > 0)
                {
                    tooltip.add(I18n.format("s9_test_001.gua_enhance_list.desc", GetGuaEnhanceString(stack, 0),
            ...
            tooltip.add(TextFormatting.AQUA +  I18n.format("s9_test_001.shared.press_shift"));
            if (use_flavor)
            {
