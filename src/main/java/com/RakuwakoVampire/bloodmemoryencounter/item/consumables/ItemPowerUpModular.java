package com.RakuwakoVampire.bloodmemoryencounter.item.consumables;

import com.RakuwakoVampire.bloodmemoryencounter.entity.creatures.EntityModUnit;
...
import com.RakuwakoVampire.bloodmemoryencounter.util.EntityUtil;
import com.RakuwakoVampire.bloodmemoryencounter.util.NBTStrDef.IDLNBTUtil;
...
import static com.RakuwakoVampire.bloodmemoryencounter.util.NBTStrDef.IDLNBTDef.MARK_TOTAL_COUNT;
    ...
    public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer playerIn, EntityLivingBase target, EnumHand handIn) {
        if (target instanceof EntityModUnit)
        {
            ...
            if (legalTarget.is_mechanic)
            {
                ...
                {
                    CommonFunctions.SafeSendMsgToPlayer(playerIn, "bloodmemoryencounter.msg.upgrade_module.req_lv", String.valueOf(requireLv));
                    return false;
                }
                ...
                if (!playerIn.world.isRemote)
                {
                    ...
                    if (success)
                    {
                        ...
                        CommonFunctions.SafeSendMsgToPlayer(playerIn, "bloodmemoryencounter.msg.upgrade_module.ok", valueBefore, valueAfter);
