package com.RakuwakoVampire.bloodmemoryencounter.item.misc;

import com.RakuwakoVampire.bloodmemoryencounter.item.IGuaEnhance;
import com.RakuwakoVampire.bloodmemoryencounter.item.ItemSwordBase;
import com.RakuwakoVampire.bloodmemoryencounter.util.IDLGeneral;
...
import static com.RakuwakoVampire.bloodmemoryencounter.util.IDLSkillNBT.GetGuaEnhance;
...
//    public com.RakuwakoVampire.bloodmemoryencounter.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.RakuwakoVampire.bloodmemoryencounter.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.RakuwakoVampire.bloodmemoryencounter.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.RakuwakoVampire.bloodmemoryencounter.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
