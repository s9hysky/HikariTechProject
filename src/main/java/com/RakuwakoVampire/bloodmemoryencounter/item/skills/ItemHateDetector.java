...
import static com.RakuwakoVampire.bloodmemoryencounter.util.NBTStrDef.IDLNBTDef.STATE;
import static com.RakuwakoVampire.bloodmemoryencounter.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.RakuwakoVampire.bloodmemoryencounter.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "bloodmemoryencounter.msg.being_targeted";
