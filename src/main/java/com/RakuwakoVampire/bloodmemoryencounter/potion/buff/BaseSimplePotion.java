package com.RakuwakoVampire.bloodmemoryencounter.potion.buff;
...
public class BaseSimplePotion extends Potion {
    protected static final ResourceLocation resource = new ResourceLocation("bloodmemoryencounter","textures/misc/potions.png");
...
//    }
    ...
    public BaseSimplePotion(boolean isBadEffectIn, int liquidColorIn, String name, int icon) {
        ...
        setPotionName("bloodmemoryencounter.potion." + name);
        iconIndex = icon;
    }
