...
public class ModConfig {
    ...
    @Config.LangKey("configgui.bloodmemoryencounter.category.Menu0.GeneralConf")
...
//        @Config.LangKey("bloodmemoryencounter.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "bloodmemoryencounter.msg.welcome";
    }

    @Config.LangKey("configgui.bloodmemoryencounter.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.bloodmemoryencounter.category.Menu0.SpawnConf")
