...
import com.RakuwakoVampire.bloodmemoryencounter.item.skills.ItemSkillBase;
import com.RakuwakoVampire.bloodmemoryencounter.util.NBTStrDef.IDLNBTDef;
...
import static com.RakuwakoVampire.bloodmemoryencounter.util.CommonDef.INT_AS_FLOAT;
import static com.RakuwakoVampire.bloodmemoryencounter.util.NBTStrDef.IDLNBTDef.*;
import static com.RakuwakoVampire.bloodmemoryencounter.util.NBTStrDef.IDLNBTUtil.*;
    ...
    public static void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag,
        ...
        if (shiftPressed)
        {
            ...
            if (showGuaSocketDesc)
            {
                ...
                if (guaTotal > 0)
                {
                    tooltip.add(I18n.format("bloodmemoryencounter.gua_enhance_list.desc", GetGuaEnhanceString(stack, 0),
            ...
            tooltip.add(TextFormatting.AQUA +  I18n.format("bloodmemoryencounter.shared.press_shift"));
            if (use_flavor)
            {
