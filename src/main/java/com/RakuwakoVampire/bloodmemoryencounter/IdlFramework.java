package com.RakuwakoVampire.bloodmemoryencounter;

import com.RakuwakoVampire.bloodmemoryencounter.gui.ModGuiElementLoader;
import com.RakuwakoVampire.bloodmemoryencounter.init.ModConfig;
import com.RakuwakoVampire.bloodmemoryencounter.init.ModRecipes;
import com.RakuwakoVampire.bloodmemoryencounter.init.ModSpawn;
import com.RakuwakoVampire.bloodmemoryencounter.init.RegistryHandler;
import com.RakuwakoVampire.bloodmemoryencounter.keys.KeyboardManager;
import com.RakuwakoVampire.bloodmemoryencounter.meta.MetaUtil;
import com.RakuwakoVampire.bloodmemoryencounter.network.NetworkHandler;
import com.RakuwakoVampire.bloodmemoryencounter.proxy.ProxyBase;
import com.RakuwakoVampire.bloodmemoryencounter.util.CommonDef;
...
import static com.RakuwakoVampire.bloodmemoryencounter.init.RegistryHandler.initRegistries;
...
public class IdlFramework {
    public static final String MODID = "bloodmemoryencounter";
    public static final String NAME = "Blood Memory Encounter";
    public static final String VERSION = "0.01.1.01";
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        if (Reference.CLIENT_PROXY_CLASS.indexOf("RakuwakoVampire.bloodmemoryencounter.proxy.ClientProxy") > 0)
        {
