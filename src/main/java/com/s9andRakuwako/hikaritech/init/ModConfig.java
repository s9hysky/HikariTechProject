...
public class ModConfig {
    ...
    @Config.LangKey("configgui.hikaritech.category.Menu0.GeneralConf")
...
//        @Config.LangKey("hikaritech.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "hikaritech.msg.welcome";
    }

    @Config.LangKey("configgui.hikaritech.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.hikaritech.category.Menu0.SpawnConf")
