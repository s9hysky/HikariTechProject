package com.s9andRakuwako.hikaritech;

import com.s9andRakuwako.hikaritech.gui.ModGuiElementLoader;
import com.s9andRakuwako.hikaritech.init.ModConfig;
import com.s9andRakuwako.hikaritech.init.ModRecipes;
import com.s9andRakuwako.hikaritech.init.ModSpawn;
import com.s9andRakuwako.hikaritech.init.RegistryHandler;
import com.s9andRakuwako.hikaritech.keys.KeyboardManager;
import com.s9andRakuwako.hikaritech.meta.MetaUtil;
import com.s9andRakuwako.hikaritech.network.NetworkHandler;
...
public class IdlFramework {
    public static final String MODID = "hikaritech";
    public static final String NAME = "Hikari Tech";
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        if (Reference.CLIENT_PROXY_CLASS.indexOf("s9andRakuwako.hikaritech.proxy.ClientProxy") > 0)
        {
