package com.s9andRakuwako.hikaritech.enchantments;
...
public class ModEnchantmentInit {
    ...
    //Example Enchant
//    public static final ModEnchantmentBase ANTI_VANILLA = new ModEnchantmentBase("hikaritech.anti_vanilla", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand)
//            .setMaxLevel(10).setValue(0.3f, 0.3f);

    public static final ModEnchantmentBase TEST_ENCHANTMENT = new ModEnchantmentBase("hikaritech.test_enchantment", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand);
