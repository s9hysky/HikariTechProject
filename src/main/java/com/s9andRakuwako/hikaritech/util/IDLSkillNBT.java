...
import com.s9andRakuwako.hikaritech.item.skills.ItemSkillBase;
import com.s9andRakuwako.hikaritech.util.NBTStrDef.IDLNBTDef;
...
import static com.s9andRakuwako.hikaritech.util.CommonDef.INT_AS_FLOAT;
import static com.s9andRakuwako.hikaritech.util.NBTStrDef.IDLNBTDef.*;
import static com.s9andRakuwako.hikaritech.util.NBTStrDef.IDLNBTUtil.*;
    ...
    public static void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag,
        ...
        if (shiftPressed)
        {
            ...
            if (showGuaSocketDesc)
            {
                ...
                if (guaTotal > 0)
                {
                    tooltip.add(I18n.format("hikaritech.gua_enhance_list.desc", GetGuaEnhanceString(stack, 0),
            ...
            tooltip.add(TextFormatting.AQUA +  I18n.format("hikaritech.shared.press_shift"));
            if (use_flavor)
            {
