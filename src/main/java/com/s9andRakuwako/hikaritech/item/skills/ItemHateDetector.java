...
import static com.s9andRakuwako.hikaritech.util.NBTStrDef.IDLNBTDef.STATE;
import static com.s9andRakuwako.hikaritech.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.s9andRakuwako.hikaritech.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "hikaritech.msg.being_targeted";
