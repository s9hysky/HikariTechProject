package com.s9andRakuwako.hikaritech.item;
...
import com.s9andRakuwako.hikaritech.entity.projectiles.ProjectileArgs;
...
public class ItemDebug extends ItemBase{
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        //tooltip.add(I18n.format("hikaritech.gua_enhance_total.desc", IDLSkillNBT.GetGuaEnhanceTotal(stack)));
